...
<script>
import Popper from '@sinlt/element-ui/src/utils/vue-popper';
import Clickoutside from '@sinlt/element-ui/src/utils/clickoutside';
import Emitter from '@sinlt/element-ui/src/mixins/emitter';
import Locale from '@sinlt/element-ui/src/mixins/locale';
import Migrating from '@sinlt/element-ui/src/mixins/migrating';
import ElInput from '@sinlt/element-ui/packages/input';
import ElTag from '@sinlt/element-ui/packages/tag';
import ElScrollbar from '@sinlt/element-ui/packages/scrollbar';
import ElCascaderPanel from '@sinlt/element-ui/packages/cascader-panel';
import AriaUtils from '@sinlt/element-ui/src/utils/aria-utils';
import { t } from '@sinlt/element-ui/src/locale';
import { isEqual, isEmpty, kebabCase } from '@sinlt/element-ui/src/utils/util';
import { isUndefined, isFunction } from '@sinlt/element-ui/src/utils/types';
import { isDef } from '@sinlt/element-ui/src/utils/shared';
import { addResizeListener, removeResizeListener } from '@sinlt/element-ui/src/utils/resize-event';
