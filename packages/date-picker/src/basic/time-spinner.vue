...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from '@sinlt/element-ui/src/utils/date-util';
  import ElScrollbar from '@sinlt/element-ui/packages/scrollbar';
  import RepeatClick from '@sinlt/element-ui/src/directives/repeat-click';
